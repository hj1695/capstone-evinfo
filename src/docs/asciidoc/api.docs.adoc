...
include::{snippets}/common/custom-response-fields-chargerTypes.adoc[]
...
operation::chargers/gets[snippets='http-request,http-response,request-parameters,response-fields']
